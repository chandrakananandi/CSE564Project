...
\hline
type of error & detect/not detect \\ \hline
...
command sent inside right method with only some policies checked & yes \\ \hline
...
\end{tabular}
\caption{\small{Types of attacks our analysis can detect at compile time. Yes indicates that an attacj are detected and no indicates that it is not detected.}}
\label{table:results}
\end{center}
\end{table*}
