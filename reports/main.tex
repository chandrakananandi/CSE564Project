...
\noindent Below are two examples of dependency policies for the smart garage door system and the smart laundry system. Due to lack of space, we omit the rest of the dependency policies. 
\begin{itemize}
...
\begin{table*}[h]
\begin{center}
\begin{tabular}{|p{4cm}|p{5cm}|p{4.5cm}|p{3.5cm}|}
\hline
controller & commands & sensors & \#dependency policies \\ \hline
